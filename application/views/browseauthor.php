...
<section id="bottom">
        <div class="container fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
            <div class="row">
                <form>
  <fieldset Enabled>
    <legend>Sort By Author</legend>
    
    <div class="mb-3">
      <label for="Select" class="form-label">Value</label>
      <select class="form-select" aria-label="Default select example">
  <option selected>Open this select menu</option>
  <option value="1">Aan Puji, Rahmawati</option>
  <option value="2">Aan Rizky Ardianto, Aan</option>
  <option value="3">Abdan Sadida, Faza</option>
</select>
    </div>
    <div class="mb-3">
