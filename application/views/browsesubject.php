                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="blog-item.html">Browse By Year</a></li>
                                <li><a href="pricing.html">Browse By Subject</a></li>
                                <li><a href="404.html">Browse By Division</a></li>
                                <li><a href="404.html">Browse By Author</a></li>
                            </ul>
                        </li>
...
<section id="bottom">
        <div class="container fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
            <div class="row">
                <form>
  <fieldset Enabled>
    <legend>Sort By Subject</legend>
    
    <div class="mb-3">
      <label for="Select" class="form-label">Value</label>
      <select class="form-select" aria-label="Default select example">
  <option selected>Open this select menu</option>
  <option value="1">Library Of Congress Subject Areas</option>
  <option value="2">A General Works</option>
  <option value="3">Philosophy,Psychology</option>
</select>
    </div>
    <div class="mb-3">
  ...
  <tbody>
    ...
    <footer id="footer" class="midnight-blue">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    &copy;  <a target="_blank" href="http://shapebootstrap.net/" title="Free Twitter Bootstrap WordPress Themes and HTML templates">CV Kreasi Teknologi Nusantara</a>. All Rights Reserved.
                </div>
                <div class="col-sm-6">
                    <ul class="pull-right">
                        <li><a href="#">Home</a></li>
