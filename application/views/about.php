...
<section id="feature">
        <div class="container">
            <div class="center fadeInDown">
                <i><u><h2>Visi Fakultas Teknologi Informasi UAJM</h2></u></i>
                <p class="lead" align="justify">Menjadi Fakultas yang terkemuka, profesional dan unggul secara nasional yang berintegritas dan berbela rasa dalam penyelenggaraan Pendidikan, Penelitian, dan Pengabdian pada Masyarakat dalam bidang penerapan dan pengembangan Teknologi Informasi.</p>
                <br>
                <i><u><h2>Misi Fakultas Teknologi Informasi UAJM</h2></u></i>
                <p class="lead" align="justify">1. Menumbuhkembangkan penyelenggaraan pendidikan akademik pada segenap Program Studi di lingkungannya secara profesional dengan potensi lulusan yang unggul, inovatif, kreatif dan memiliki integritas dalam memenuhi kebutuhan bangsa.</p>

                <p class="lead" align="justify">2. Meningkatkan peran fakultas ditengah masyarakat melalui kegiatan penelitian, pengabdian, pengembangan dan penyebarluasan ilmu pengetahuan dan teknologi, khususnya pada bidang Teknologi Informasi guna meningkatkan taraf kehidupan masyarakat, bangsa dan umat manusia demi kemajuan dan kesejahteraan bangsa serta seluruh umat manusia.</p>
                <br>
                <br>
                <i><u><h2>Tujuan Fakultas Teknologi Informasi UAJM</h2></u></i>
                <p class="lead" align="justify">1. Menghasilkan lulusan yang memiliki keunggulan profesional dan personal dengan semangat pantang berhenti belajar dalam menerapkan serta mengembangkan dan menerapkan ilmunya guna meningkatkan kesejahteraan dirinya dan bangsanya.</p>

                <p class="lead" align="justify">2. Menghasilkan penelitian yang bermutu dan bermanfaat bagi peningkatan kesejahteraan masyarakat.</p>

                <p class="lead" align="justify">3. Men-dharmabaktikan hasil pembelajaran dan penelitian bagi peningkatan kesejahteraan dan kecerdasan masyarakat. </p>
